...
import { dedupKey, groupEvents, sourceColors, sourceCount } from "../../src/lib/helpers/eventGroup.js"
...
describe("dedupKey", () => {
	it("prefers the iCal UID when present", () => {
		...
		expect(dedupKey(ne)).toBe("uid:standup@google.com")
	})
...
describe("groupEvents", () => {
	...
	it("cancelled status survives via the primary source", () => {
		const cancelledCopy = { id: "p3", uid: "standup@google.com", title: "Standup", start: "2026-09-15T09:30", status: "cancelled" as const }
