...
import { connectCalendars, isCalendarSource, type CalendarSource } from "../../src/lib/helpers/connectCalendars.js"
...
describe("connectCalendars", () => {
	...
	it("respects an event's own calendarId without overwriting", async () => {
		const a = source("a", [{ id: "a1", title: "Pinned", start: "2026-09-02", calendarId: "elsewhere" }])
