...
test.describe("Docs locale switcher", () => {
  ...
  test("Switch docs page switches to Persian", async ({ page }) => {
  ...
  test("CalendarInput docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "CalendarInput", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("ColorPicker docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "ColorPicker", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("FileUpload docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "FileUpload", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("FloatLabel docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "FloatLabel", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Form docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Form", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("ListInput docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "ListInput", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Listbox docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Listbox", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Combobox docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Combobox", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("AutoComplete docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "AutoComplete", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Dropdown docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Dropdown", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Modal docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Modal", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Toast docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Toast", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Stepper docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Stepper", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("StepperStep docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "StepperStep", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Alert docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Alert", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("ButtonGroup docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "ButtonGroup", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });

  test("Icon docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "Icon", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
    await expect(page.getByRole("heading", { name: "سفارشی‌سازی", level: 2 })).toBeVisible();
  });
  ...
  test("EventsTable docs page switches to Persian", async ({ page }) => {
    ...
    const heading = page.getByRole("heading", { name: "EventsTable", level: 1 });
    await expect(heading).toBeVisible();
    await expect(page.locator("html")).toHaveAttribute("dir", "rtl");
  });
