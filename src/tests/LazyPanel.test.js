...
test.describe('LazyPanel Component', () => {
  ...
  test('handles custom loading state', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-panel-lazypanel--with-custom-loading');
  ...
  test('loads multiple panels as they become visible', async ({ page }) => {
    await page.goto('http://localhost:6006/?path=/story/components-panel-lazypanel--multiple-with-scroll');
