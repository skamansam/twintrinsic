...
test.describe('AutoComplete Component', () => {
  ...
  test('handles custom template', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-form-autocomplete--custom-template');
  ...
  test('handles minimum length requirement', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-form-autocomplete--with-min-length');
  ...
  test('handles force selection', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-form-autocomplete--force-selection');
  ...
  test('handles custom filter', async ({ page }) => {
    ...
    await page.goto('http://localhost:6006/?path=/story/components-form-autocomplete--custom-filter');
