...
export const propsMetadata = [
  ...
  { name: "onbarclick", type: "(event: MouseEvent | KeyboardEvent, detail: Readonly<{ seriesIndex: number; barIndex: number; value: number }>) => void", description: "Callback when a bar is clicked (mouse or keyboard activation)", optional: true },
