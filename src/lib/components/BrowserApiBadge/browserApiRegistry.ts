...
export const browserApiRegistry: Record<string, BrowserApi[]> = {
	// Temporal date math (CalendarView grid, events, drag deltas)
	CalendarView: [
		{
			label: "Temporal",
			mdnUrl: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal",
	...
	// Overflow "+N more" popovers per day cell
	"CalendarView (+N more)": [
		{
			label: "Popover",
			mdnUrl: "https://developer.mozilla.org/en-US/docs/Web/API/Popover_API",
