<script module>
  ...
  const users = [
    ...
    { id: 6, name: "Diana Miller", email: "diana.miller@example.com", role: "Admin", status: "Inactive" },
    { id: 7, name: "Edward Davis", email: "edward.davis@example.com", role: "Viewer", status: "Active" },
    { id: 8, name: "Fiona Wilson", email: "fiona.wilson@example.com", role: "Editor", status: "Active" },
    { id: 9, name: "George Moore", email: "george.moore@example.com", role: "Viewer", status: "Inactive" },
    { id: 10, name: "Hannah Taylor", email: "hannah.taylor@example.com", role: "Admin", status: "Active" },
    { id: 11, name: "Ian Anderson", email: "ian.anderson@example.com", role: "Editor", status: "Active" },
    { id: 12, name: "Julia Thomas", email: "julia.thomas@example.com", role: "Viewer", status: "Inactive" },
  ];
