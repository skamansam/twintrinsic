...
const { Story } = defineMeta({
  ...
  tags: ["autodocs"],
  argTypes: {
    vertical: { control: "boolean", description: "Whether the separator should be vertical", defaultValue: false },
    color: { control: "select", options: ["default", "primary", "success", "warning", "error"], description: "Color variant of the separator", defaultValue: "default" },
    as: { control: "select", options: ["div", "hr"], description: "HTML element to render" },
...
<Story name="Vertical With Content" args={{ vertical: true }}>
  <div class="h-32 flex items-center">
    <span>Account</span>
    <Separator vertical>
      <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
