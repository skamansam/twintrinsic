...
| **[CALENDARVIEW_DESIGN.md](./CALENDARVIEW_DESIGN.md)** | CalendarView design note — Temporal date model, month grid, event grouping, connectivity (plan item 11.1, Final) |
