...
> **Last counted 2026-09-10.** 81 of 85 items completed (95%). All P1 items complete! Remaining: 2 P2 + 2 P3 — chiefly finishing the i18n sweep (1.9), restoring translated prose in `llms.txt` (1.11), and FormBuilder `$ref`/composition resolution (7.10).
