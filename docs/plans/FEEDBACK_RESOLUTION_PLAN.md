...
> **Last counted 2026-09-17.** 85 of 88 items completed — the USER_FEEDBACK.md backlog is fully resolved (100%). The open items are the new feature requests: **11.1 CalendarView** (Temporal-API calendar grid — design finalized in `CALENDARVIEW_DESIGN.md`), **11.2 per-component docs iconography (Iconify, one consistent iconset)**, and **11.3 browser-API title badges with polyfill tooltips**.
