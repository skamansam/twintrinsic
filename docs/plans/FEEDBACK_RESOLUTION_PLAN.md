...
> **Last counted 2026-09-18.** 87 of 89 items completed — the USER_FEEDBACK.md backlog is fully resolved (100%); of the feature requests, **11.1 CalendarView** and **11.3 browser-API title badges** have shipped and **11.2 per-component docs iconography** is planned. A new request, **11.4 Holiday-calendar playground demo** (Google public holiday feeds + event management sandbox), is now tracked below.
