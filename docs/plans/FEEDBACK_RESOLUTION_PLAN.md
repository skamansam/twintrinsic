...
> **Last counted 2026-09-18.** 88 of 89 items completed — the USER_FEEDBACK.md backlog is fully resolved (100%); of the feature requests, **11.1 CalendarView**, **11.3 browser-API title badges** and **11.4 holiday-calendar playground** have shipped and **11.2 per-component docs iconography** is in progress.
